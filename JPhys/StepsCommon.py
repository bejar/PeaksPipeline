...
if __name__ == '__main__':
    dfiles = ['01140515.csv',  '02281113.csv',  '03060911.csv',  '04280213.csv',  '05160512.csv', '06180912.csv', '07160611.csv']  # '06180912.csv'
    ...
    data = pd.read_csv(dfiles[5], sep='\t', index_col=0)

    for c1 in data.columns:
        for c2 in data.columns:
            print c1, c2, kendalltau(data[c1], data[c2])
