...
python Clustering/PeaksSaveClustering.py --batch --exp e160204
python Clustering/PeaksClusteringHisto.py --batch --exp  e160204
python Secuencias/PeaksComputeGraphsIcons.py --batch --exp   e160204
